function getReply(command) {
  ...
  if (myCommand[0] == "Hello") {
    if (namesOfUser.includes(myCommand[4]) === false) {
      namesOfUser.push(myCommand[4]);
    }
    console.log("Nice to meet you " + myCommand[4]);
  }
  ...
  if (myCommand[0] == "What") {
    if (command == "What is my name?") {
      if (namesOfUser != 0) {
        ...
        console.log(
          "You have not told me your name! Please tell me your name!"
        );
      }
    }
